...
public class Poses {
    ...
    public static final Pose shootPoseBlueFar = new Pose(10.1, 86, Math.toRadians(22)); // Scoring Pose of our robot. It is facing the goal at a 135 degree angle.
    ...
    public static final Pose shootPoseRedClose = new Pose(83.5, 59, Math.toRadians(312.5));
    ...
    //close
    public static final Pose spike1PoseBlue = new Pose(79.2, 95, 1.56); // Highest (First Set) of Artifacts from the Spike Mark.
    public static final Pose spike1EndPoseBlue = new Pose(79.2, 122, 1.56); // Highest (First Set) of Artifacts from the Spike Mark.

    public static final Pose spike2PoseBlue = new Pose(56.5, 95, 1.56); // Highest (First Set) of Artifacts from the Spike Mark.
    public static final Pose spike2EndPoseBlue = new Pose(56.5, 129, 1.56); // Highest (First Set) of Artifacts from the Spike Mark.
    ...
    public static final Pose spike2EndPoseFastBlue = new Pose(55, 20, Math.toRadians(-90)); // Highest (First Set) of Artifacts from the Spike Mark.

    public static final Pose spike3PoseBlue = new Pose(31.5, 95, 1.56); // Highest (First Set) of Artifacts from the Spike Mark.
    public static final Pose spike3EndPoseBlue = new Pose(31.5, 129, 1.56); // Highest (First Set) of Artifacts from the Spike Mark.
    ...
    public static final Pose spike2EndPoseFastRed = new Pose(55, 29, Math.toRadians(-90)); // Highest (First Set) of Artifacts from the Spike Mark.
    ...
    public static final Pose gatePushAngleRed = new Pose(55, 15, -1); // Highest (First Set) of Artifacts from the Spike Mark.
    public static final Pose gatePushAngleBezierRed = new Pose(53, 50, Math.toRadians(0)); // Highest (First Set) of Artifacts from the Spike Mark.

    public static final Pose gateBackupAngleRed = new Pose(45, 13, -0.5); // Highest (First Set) of Artifacts from the Spike Mark.

    public static final Pose gatePoseSpikeBlue = new Pose(-17, 54.5, Math.toRadians(58)); // Highest (First Set) of Artifacts from the Spike Mark.
    public static final Pose gatePoseSpikeRed = new Pose(63, 21, Math.toRadians(-90)); // Highest (First Set) of Artifacts from the Spike Mark.
    ...
    public static final Pose spike3PoseRedFar = new Pose(29.5, 49, Math.toRadians(-90)); // Highest (First Set) of Artifacts from the Spike Mark.
    public static final Pose spike3EndPoseRedFar = new Pose(29.5, 17, Math.toRadians(-90)); // Highest (First Set) of Artifacts from the Spike Mark.
    ...
    public static final Pose backupHPPoseRed = new Pose(5, 19, Math.toRadians(-90)); // Scoring Pose of our robot. It is facing the goal at a 135 degree angle.
...
*/
    ...
    public static final Pose gateOverFlowPoseBlueFar = new Pose(3, 130, Math.toRadians(35)); // Highest (First Set) of Artifacts from the Spike Mark.
    public static final Pose gateOverFlowPoseRedFar = new Pose(3, 14, Math.toRadians(-35)); // Highest (First Set) of Artifacts from the Spike Mark.

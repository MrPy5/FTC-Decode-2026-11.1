...
public class Poses {
    ...
    public static final Pose gateTurn1Red = new Pose(69, 30, Math.toRadians(0));
    public static final Pose gatePush1Red = new Pose(69, 15, Math.toRadians(0));
    ...
    public static final Pose spike2EndPoseRed = new Pose(55, 12, Math.toRadians(-90)); // Highest (First Set) of Artifacts from the Spike Mark.
    ...
    public static final Pose spike3EndPoseRed = new Pose(31, 12, Math.toRadians(-90)); // Highest (First Set) of Artifacts from the Spike Mark.
    ...
    public static final Pose gateOverFlowPoseBlueFar = new Pose(10, 135, Math.toRadians(10)); // Highest (First Set) of Artifacts from the Spike Mark.
